...
const SearchJobsCategory = () => {
    return ( 
        ...
        <div className="container" id="categories2">
            <h3>Search by Category</h3>
                <div id="categoryCards">
                    <div className="card">
                        <h4 className="text-light">IT & Development</h4>
                    </div>
                    <div className="card">
                    <h4 className="text-light">Design & Creative</h4>
                    </div>
                    <div className="card">
                        <h4 className="text-light">Sales and Marketing</h4>
                    </div>
                    <div className="card">
                        <h4 className="text-light">Writing & Translation</h4>
                    </div>
                    <div className="card">
                        <h4 className="text-light">Admin & Support</h4>
                    </div>
                    <div className="card">
                        <h4 className="text-light">Finance & Accounting</h4>
                    </div>
                    <div className="card">
                        <h4 className="text-light">Engineering <br/>& Architecture</h4>
                    </div>
                    <div className="card">
...
export default SearchJobsCategory;